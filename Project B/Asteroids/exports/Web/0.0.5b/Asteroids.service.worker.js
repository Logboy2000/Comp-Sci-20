...
/** @type {string} */
const CACHE_VERSION = '1734984598|4841308908';
/** @type {string} */
const CACHE_PREFIX = 'Asteroids-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Asteroids.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Asteroids.html","Asteroids.js","Asteroids.offline.html","Asteroids.icon.png","Asteroids.apple-touch-icon.png","Asteroids.worker.js","Asteroids.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Asteroids.wasm","Asteroids.pck"];
