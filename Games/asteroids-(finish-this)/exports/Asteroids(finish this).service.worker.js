...
/** @type {string} */
const CACHE_VERSION = '1732001725|624508778';
/** @type {string} */
const CACHE_PREFIX = 'Asteroids (finis-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Asteroids(finish this).offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Asteroids(finish this).html","Asteroids(finish this).js","Asteroids(finish this).offline.html","Asteroids(finish this).icon.png","Asteroids(finish this).apple-touch-icon.png","Asteroids(finish this).worker.js","Asteroids(finish this).audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Asteroids(finish this).wasm","Asteroids(finish this).pck"];
